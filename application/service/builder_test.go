...
// 	config.CurrentConfiguration.SetConfiguration(map[string]config.RouteDefinition{})
// 	config.CurrentConfiguration.SetDefaultConfiguration()

// 	extendedConfig := config.CurrentConfiguration.GetConfiguration()

// 	extendedConfig["/no-details"] = config.RouteDefinition{}

// 	base64content := "base64,SGVsbG8sIFdvcmxkIQ=="
// 	extendedConfig["/base64"] = config.RouteDefinition{
// 		Content: &base64content,
// 	}

// 	badBase64content := "base64,ThisIsNotValidAtAll123!%"
// 	extendedConfig["/bad-base64"] = config.RouteDefinition{
